...
import org.lazarev.dao.AppDocumentDAO;
import org.lazarev.dao.AppPhotoDAO;
import org.lazarev.dao.BinaryContentDAO;
...
public class FileServiceImpl implements FileService {
    ...
    public AppPhoto processPhoto(Message telegramMessage) {
        ...
        if (response.getStatusCode() == HttpStatus.OK) {
            ...
            AppPhoto transientAppPhoto = buildAppTransientPhoto(telegramPhoto, persistentBinaryContent);
...
//    }
    ...
    private AppPhoto buildAppTransientPhoto(PhotoSize telegramPhoto, BinaryContent persistentBinaryContent) {
